...
export const NavbarIcon = ({text,Icon})=> {
    ...
    return (
        <button 
            ...
            className={`relative flex justify-center items-center px-3 py-2 rounded-md hover:bg-[#394b55] cursor-pointer ${active_navbar === text && 'bg-[#394b55] border border-[#33424b]'}`}>
